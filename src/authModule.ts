import type { SilentRequest, AuthenticationResult, Configuration, AccountInfo, RedirectRequest, PopupRequest, EndSessionRequest, SsoSilentRequest } from "@azure/msal-browser";
...
const MSAL_CONFIG: Configuration = {
    auth: {
        clientId: "1f4a4097-31eb-4a57-a09d-358673f748d8",
        authority: "https://login.microsoftonline.com/34e12086-196c-45a1-8c31-10bef6527faf"
    },
    cache: {
...
export class AuthModule {
    ...
    * @param response 
    ...
    handleResponse(response: AuthenticationResult | null) {
        ...
        if (this.account) {
            console.log(`INFO - AUTH${this.account}`);
        }
    }
    ...
    //  */
    // attemptSsoSilent() {
    //     this.myMSALObj.ssoSilent(this.).then(() => {
    //         this.account = this.getAccount();
    //         if (this.account) {
    //             console.log(`INFO - Silent SSO - ${this.account}`);
